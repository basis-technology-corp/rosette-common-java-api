...
/**
 * FSA guts with no heap copy.
 */
//CHECKSTYLE:OFF
class NoncopyingFsaEngine implements FsaGuts {
    final ByteBuffer data;
    final CharBuffer charData;
    final int guardIndexDelta;

    NoncopyingFsaEngine(ByteBuffer data, int guardIndexDelta) {
        this.data = data;
        data.rewind();
    ...
    @Override
    public int take5SearchInternal(Take5Dictionary dict, char[] input, int offset, int length, Take5Match match, Take5Match[] matches, int startState, int startIndex) {
